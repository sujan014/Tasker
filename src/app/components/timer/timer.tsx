...
import Number_to_Digit from '../utils/Number_to_digit';
    ...
    <div className="flex flex-col">
      ...
      {/* <div>
        <p className="text-3xl text-blue-600">
          Timer start at: <span className="text-blue-600">{startTime}</span>
        </p>
        <p className="text-3xl text-red-600">
          Timer end at: <span className="text-blue-600">{endTime}</span>
        </p>
      </div> */}
    </div>
  );
